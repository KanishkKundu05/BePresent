...
final class MacDiagnostics: @unchecked Sendable {
  ...
  static let shared = MacDiagnostics(
    directory: FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
      .appendingPathComponent("BePresent/Diagnostics", isDirectory: true)
  )
  ...
  private let queue = DispatchQueue(label: "com.bepresent.brick.diagnostics", qos: .utility)
  private let logger = Logger(subsystem: "com.bepresent.brick.mac", category: "diagnostics")
