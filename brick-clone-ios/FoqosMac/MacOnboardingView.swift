  ...
  var body: some View {
    VStack(spacing: 0) {
      ...
      Image("FoqosStickerLogo")
        ...
        .accessibilityLabel("BePresent hourglass")

      Spacer(minLength: 30)

      VStack(spacing: 0) {
        SetupProgressRow(
          title: "Install the BePresent network extension",
        ...
        SetupProgressRow(
          title: "Enable BePresent in Login Items & Extensions",
    ...
    .onReceive(
      ...
      MacDiagnostics.shared.record(
        ...
        "BePresent became active while onboarding was visible; rechecking filter status."
      )
      filterManager.refreshStatus()
    }
  }
