  ...
  func export() {
    ...
    exportTask = Task { @MainActor in
      ...
      do {
        ...
        panel.title = "Export BePresent Diagnostics"
        panel.message = "Save setup and sync diagnostics to share with BePresent support."
        panel.allowedContentTypes = [.zip]
        panel.canCreateDirectories = true
        panel.nameFieldStringValue =
          "BePresent-Diagnostics-\(Date().formatted(.iso8601.year().month().day())).zip"
