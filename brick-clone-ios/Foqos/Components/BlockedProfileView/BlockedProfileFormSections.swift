...
struct BlockedProfileDomainsFields: View {
  ...
  var body: some View {
    ...
    CustomToggle(
      title: "Sync to Mac",
      description:
        "Block the same selected domains on your Mac with the BePresent for Mac app.",
...
struct BlockedProfileStrictSafeguardsFields: View {
  ...
  var body: some View {
    CustomToggle(
      ...
      description:
        "Stop apps from being deleted during sessions, including BePresent.",
...
struct BlockedProfileSessionSafeguardsFields: View {
  ...
  var body: some View {
    CustomToggle(
      title: "Require BePresent to Stop",
      description:
