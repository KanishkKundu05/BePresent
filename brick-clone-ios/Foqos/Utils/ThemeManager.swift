...
class ThemeManager: ObservableObject {
  ...
  static let availableColors: [(name: String, color: Color)] = [
    ("BePresent Blue", Color(hex: "#1736F5"))
  ]

  private static let defaultColorName = "BePresent Blue"

  @AppStorage(
    "foqosThemeColorName", store: UserDefaults(suiteName: "group.com.bepresent.brick"))
