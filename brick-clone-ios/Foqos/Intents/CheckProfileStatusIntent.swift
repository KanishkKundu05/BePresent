...
struct CheckProfileStatusIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "BePresent Profile Status"
  static var parameterSummary: some ParameterSummary {
    Summary("Check whether \(\.$profile) is active")
  }
  static var description = IntentDescription(
    "Check if a BePresent profile is currently active and return the status as a boolean value.")
