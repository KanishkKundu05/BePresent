...
struct StartBreakIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Start BePresent Break"
  static var description = IntentDescription(
    "Start a break from the active BePresent session using its remaining break allowance. Breaks must be enabled for the profile."
  )
