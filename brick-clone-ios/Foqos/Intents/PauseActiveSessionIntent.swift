...
struct PauseActiveSessionIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Pause Active BePresent Session"
  static var description = IntentDescription(
    "Pause the currently active BePresent session when its strategy supports pausing."
  )
