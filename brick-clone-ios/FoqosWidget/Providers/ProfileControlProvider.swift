...
struct ProfileControlProvider: AppIntentTimelineProvider {
  ...
  private let logger = Logger(subsystem: "com.bepresent.brick", category: "Widget")
  ...
  private func entry(for configuration: Intent) async -> Entry {
    ...
    do {
      ...
      return Entry(
        date: now, selectedProfileId: nil, profileName: "BePresent", activeSession: nil,
        profileInfo: nil, deepLinkURL: URL(string: "bepresent://"), focusMessage: "",
