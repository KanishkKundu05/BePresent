...
struct ProfileWidgetEntry: TimelineEntry {
  ...
  var destination: URL {
    if isSessionActive || hasOtherActiveProfile { return URL(string: "bepresent://")! }
    return deepLinkURL ?? URL(string: "bepresent://")!
  }

  var statusLabel: String {
    if isDataUnavailable { return "Open BePresent to refresh" }
